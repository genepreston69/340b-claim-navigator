...
-- Tracks fill rates, medication adherence, and PDC (Proportion of Days Covered)
-- =============================================================================
...
SELECT
    ...
    total_payments,
    total_340b_cost,
    -- Expected fills (initial + refills)
...
-- Analyzes prescriber-level 340B capture rates and performance
-- =============================================================================
...
SELECT
    ...
    -- Lost opportunity (unfilled scripts * avg payment)
...
-- Shows which drugs are filled as 340B eligible at which pharmacies
-- =============================================================================
...
-- Identifies pharmacies that may not be contracted (no claims activity)
-- =============================================================================
...
-- Aggregates adherence metrics by month for trend analysis
-- =============================================================================
...
-- Summarizes adherence metrics by drug/medication
-- =============================================================================
